...
bool interfaces__msg__uint8_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._uint8_array.Uint8Array", full_classname_dest, 38) == 0);
  }
  interfaces__msg__Uint8Array * ros_message = _ros_message;
  {  // data
...
{
  /* NOTE(esteve): Call constructor of Uint8Array */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._uint8_array");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Uint8Array");
